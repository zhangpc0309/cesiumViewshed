define("Scene/Scene", ["../Core/BoundingRectangle", "../Core/BoundingSphere", "../Core/BoxGeometry", "../Core/Cartesian2", "../Core/Cartesian3", "../Core/Cartesian4", "../Core/Cartographic", "../Core/Color", "../Core/ColorGeometryInstanceAttribute", "../Core/createGuid", "../Core/CullingVolume", "../Core/defaultValue", "../Core/defined", "../Core/defineProperties", "../Core/destroyObject", "../Core/DeveloperError", "../Core/EllipsoidGeometry", "../Core/Event", "../Core/GeographicProjection", "../Core/GeometryInstance", "../Core/GeometryPipeline", "../Core/getTimestamp", "../Core/Intersect", "../Core/Interval", "../Core/JulianDate", "../Core/Math", "../Core/Matrix4", "../Core/mergeSort", "../Core/Occluder", "../Core/OrthographicFrustum", "../Core/OrthographicOffCenterFrustum", "../Core/PerspectiveFrustum", "../Core/PerspectiveOffCenterFrustum", "../Core/PixelFormat", "../Core/Plane", "../Core/Ray", "../Core/RequestScheduler", "../Core/ShowGeometryInstanceAttribute", "../Core/TaskProcessor", "../Core/Transforms", "../LSSource/LSPitCollection", "../LSSource/LSSetSurfaceTransparency", "../LSSource/LSWaterCollection", "../Renderer/ClearCommand", "../Renderer/ComputeEngine", "../Renderer/Context", "../Renderer/ContextLimits", "../Renderer/DrawCommand", "../Renderer/Framebuffer", "../Renderer/Pass", "../Renderer/PassState", "../Renderer/PixelDatatype", "../Renderer/RenderState", "../Renderer/ShaderProgram", "../Renderer/ShaderSource", "../Renderer/Texture", "./BrdfLutGenerator", "./Camera", "./CreditDisplay", "./DebugCameraPrimitive", "./DepthPlane", "./DeviceOrientationCameraController", "./EllipsoidPrimitive", "./Fog", "./FrameState", "./FrustumCommands", "./FXAA", "./GlobeDepth", "./InvertClassification", "./JobScheduler", "./MapMode2D", "./OIT", "./PerformanceDisplay", "./PerInstanceColorAppearance", "./PickDepth", "./Primitive", "./PrimitiveCollection", "./SceneMode", "./SceneTransforms", "./SceneTransitioner", "./ScreenSpaceCameraController", "./ShadowMap", "./SunPostProcess", "./TweenCollection", "../LSSource/LSPageLODCollection"], function (e, t, r, i, n, o, a, s, l, u, c, d, h, p, f, m, g, _, v, y, b, C, S, w, T, x, E, A, P, D, I, O, M, R, L, N, k, B, F, U, V, z, G, H, W, j, q, Y, X, Q, Z, K, J, $, ee, te, re, ie, ne, oe, ae, se, le, ue, ce, de, he, pe, fe, me, ge, _e, ve, ye, be, Ce, Se, we, Te, xe, Ee, Ae, Pe, De, Ie) {
    "use strict";
    ...
    function Oe(t) {
        ...
        var p = new Z(c);
        p.viewport = new e, p.viewport.x = 0, p.viewport.y = 0, p.viewport.width = c.drawingBufferWidth, p.viewport.height = c.drawingBufferHeight, this._passState = p, this._canvas = r, this._context = c, this._computeEngine = new W(c), this._globe = void 0, this._primitives = new Se, this._groundPrimitives = new Se, this._pageLODs = new Ie, this._tweens = new De, this._shaderFrameCount = 0, this._sunPostProcess = void 0, this._computeCommandList = [], this._frustumCommandsList = [], this._overlayCommandList = [], this._pickFramebuffer = void 0, this._useOIT = d(t.orderIndependentTranslucency, !0), this._executeOITFunction = void 0;
        var f;
        ...
        }, this._ellipsoidPrimitive = new le, this._ellipsoidPrimitive.center = new n(0, 0, 0), this._ellipsoidPrimitive.radii = n.multiplyByScalar(new n(6378137, 6378137, 6356752), .9995, new n), this._ellipsoidPrimitive.material.uniforms.color = new s(0, 0, 0, 1), this._ellipsoidPrimitive.show = !1, this._primitives.add(this._ellipsoidPrimitive), this._pitCollection = new V(this), this._waterCollection = new G(this), this._setSurfaceTransparency = new z(this), this._useWebVR = !1, this._cameraVR = void 0, this._aspectRatioVR = void 0, this._useSingleFrustum = !0, this.requestRenderMode = d(t.requestRenderMode, !1), this._renderRequested = !0, this._lastFpsSampleTime = C(), this._fpsFrameCount = 0, this.maximumRenderTimeChange = d(t.maximumRenderTimeChange, 0), this._lastRenderTime = void 0, this._removeRequestListenerCallback = k.requestCompletedEvent.addEventListener(At(this)), this._removeTaskProcessorListenerCallback = F.taskCompletedEvent.addEventListener(At(this)), this._removeGlobeCallbacks = [];
    ...
    function Ke(e, t) {
        ...
        for (var T = 0; T < w; ++T) {
            ...
            if (0 == e._setSurfaceTransparency._enabled || D >= 1e4) {
                e._ellipsoidPrimitive.show = !1, n.updatePass(Q.GLOBE);
            ...
            var R;
            if (!u && d.useInvertClassification && e.frameState.invertClassificationColor.alpha < 1 && (R = e._invertClassification), n.updatePass(Q.TRANSLUCENT), I = E.commands[Q.TRANSLUCENT], I.length = E.indices[Q.TRANSLUCENT], m(e, qe, t, I, R), 1 == e._setSurfaceTransparency._enabled && D < 1e4) {
    ...
    function ut(e) {
        var t = e._frameState;
        t._scene = e, e._groundPrimitives.update(t), e._primitives.update(t), e._pageLODs.update(t), st(e), lt(e), e._globe && e._globe.render(t)
    }
