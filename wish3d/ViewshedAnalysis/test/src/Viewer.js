define([
    ...
    var BoundingSphere=Cesium.BoundingSphere,
        ...
        computeFlyToLocationForRectangle=Cesium.computeFlyToLocationForRectangle,
        ImageryLayer=Cesium.ImageryLayer,
        SceneMode=Cesium.SceneMode,
        TimeDynamicPointCloud=Cesium.TimeDynamicPointCloud,
        knockout=Cesium.knockout,
        when=Cesium.when,
        Animation=Cesium.Animation,
        AnimationViewModel=Cesium.AnimationViewModel,
        BaseLayerPicker=Cesium.BaseLayerPicker,
        createDefaultImageryProviderViewModels=Cesium.createDefaultImageryProviderViewModels,
        createDefaultTerrainProviderViewModels=Cesium.createDefaultTerrainProviderViewModels,
        ...
        subscribeAndEvaluate=Cesium.subscribeAndEvaluate,
