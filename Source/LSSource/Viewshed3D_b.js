define([
    ...
    Viewshed3D.prototype.detachViewshed = function(e) {
        ...
        for (var t = this._childViewsheds.length, r = 0; r < t; ++r) if (this._childViewsheds[r] === e) {
            return e._childViewsheds.splice(r, 1), e._parentViewshed = void 0, !0;
        }
        return !1
    };
    ...
    Viewshed3D.prototype._updateHintLine = function(e) {
        ...
        if (e.cullingVolume.computeVisibility(A) === u.OUTSIDE) {
        ...
        if (o(this._drawLineCommand)) {
            this._drawLineCommand.vertexArray.destroy(), this._drawLineCommand.vertexArray = X, this._drawLineCommand.modelMatrix = this._modelMatrix, this._drawLineCommand.boundingVolume = A;
        } else {
    ...
    Viewshed3D.prototype.updateDepthMap = function(e) {
        if (0 !== this._distance) {
            ...
            if (this._hintLineUpdated || this._updateHintLine(t), this._valid) {
                h.multiply(e.camera.workingFrustums[0].projectionMatrix, e.camera.viewMatrix, this._textureViewMatrix), h.inverse(this._textureViewMatrix, this._textureViewMatrix), h.multiply(this._depthCamera.viewMatrix, this._textureViewMatrix, this._textureViewMatrix), h.clone(this._depthCamera.frustum.projectionMatrix, this._textureProjMatrix);
